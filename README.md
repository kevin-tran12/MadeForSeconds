...
│   ├── tests/                  Pytest suite (609 tests across 32 files)
...
npm run test:backend                    # Pytest (609 tests)
...
### Backend — pytest (609 tests, 32 files)
```bash
...
### Frontend unit — vitest (101 tests, 15 files)
```bash
npm run test:unit
```
Covers: API client, expense math, hooks (useRecipes, useRecipe, useCategories), UI components, support and donation-link pages.
